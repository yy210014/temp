...
function Trig_GetItemActions takes nothing returns nothing
    ...
    if ( ( ( gui == "小黄鸡1号" ) or ( gui == "小黄鸡2号" ) or ( gui == "小黄鸡3号" ) or ( gui == "小黄鸡4号" ) or ( gui == "小黄鸡5号" ) or ( gui == "小黄鸡6号" ) or ( gui == "小黄鸡7号" ) or ( gui == "小黄鸡8号" ) or ( gui == "小黄鸡9号" ) or ( gui == "小黄鸡10号" ) or ( gui == "小黄鸡军团1号" ) or ( gui == "小黄鸡军团2号" ) or ( gui == "小黄鸡军团3号" ) or ( gui == "小黄鸡军团4号" ) or ( gui == "小黄鸡军团5号" ) or ( gui == "小黄鸡军团6号" ) or ( gui == "小黄鸡军团7号" ) or ( gui == "小黄鸡军团8号" ) or ( gui == "小黄鸡军团9号" ) or ( gui == "小黄鸡军团10号" ) ) ) then
        ...
        call DisplayTextToPlayer(GetOwningPlayer(GetManipulatingUnit()), 0, 0, "|cffff0000领取失败,未加入小黄鸡公会,请加入小黄鸡1~10号或小黄鸡军团1~10号公会.|r")
    endif
endfunction
//===========================================================================
...
function config takes nothing returns nothing
    call SetMapName("召唤师联盟TD内测版1.22")
