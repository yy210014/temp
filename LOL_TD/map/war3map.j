...
function Trig_InitItemCellActions takes nothing returns nothing
    ...
    set udg_ItemAps[6]='I037'
    set udg_ItemAps[7]='I041'
    set udg_ItemAps[8]='I098'
    set udg_ItemAps[9]='I066'
    set udg_ItemAps[10]='I071'
    set udg_ItemAps[11]='I096'
    set udg_ItemAps[12]='I083'
    set udg_ItemAps[13]='I064'
    set udg_ItemAps[14]='I069'
    set udg_ItemAps[15]='I075'
    set udg_ItemAps[16]='I100'
    set udg_ItemAps[17]='I090'
    set udg_ItemAps[18]='I073'
    set udg_ItemAps[19]='I077'
    set bj_forLoopAIndex=1
    set bj_forLoopAIndexEnd=25
    loop
        exitwhen bj_forLoopAIndex > bj_forLoopAIndexEnd
        if ( ( bj_forLoopAIndex > 19 ) ) then
            set bj_forLoopBIndex=1
            set bj_forLoopBIndexEnd=4
            loop
                exitwhen bj_forLoopBIndex > bj_forLoopBIndexEnd
    ...
    call SaveInteger(YDHT, 'I096', 0x437E2A40, 'I028')
...
function Trig_initialActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT1", 0), "|cffff6600刘二狗子|r")
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT5", 0), "100000")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT6", 0), "100000")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    ...
    call DzFrameSetText(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], "100")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT8", 0), "100/100")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT9", 0), "100/100")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT11", 0), "物理穿透")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT12", 0), "法术穿透")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT13", 0), "物理加成")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT14", 0), "法术加成")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT15", 0), "攻速")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT16", 0), "暴击")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT17", 0), "爆伤")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    ...
    call DzFrameSetText(DzFrameFindByName("UIATEXT18", 0), "冷却缩减")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
...
function Trig_SelectedUnitActions takes nothing returns nothing
    call GroupAddUnit(udg_SelectedUnitGroup[GetPlayerId(GetTriggerPlayer())], GetTriggerUnit())
    ...
    if ( ( GetTriggerPlayer() == GetLocalPlayer() ) ) then
        if ( ( CountUnitsInGroup(udg_SelectedUnitGroup[GetPlayerId(GetTriggerPlayer())]) > 1 ) ) then
            call DzFrameShow(udg_ui_ZT[0], false)
        else
...
function Trig_DeSelectedUnitActions takes nothing returns nothing
    call GroupRemoveUnit(udg_SelectedUnitGroup[GetPlayerId(GetTriggerPlayer())], GetTriggerUnit())
    set udg_ZT_hero[GetConvertedPlayerId(GetTriggerPlayer())]=null
    if ( ( CountUnitsInGroup(udg_SelectedUnitGroup[GetPlayerId(GetTriggerPlayer())]) == 0 ) ) then
        call DzFrameShow(udg_ui_ZT[0], false)
    else
    endif
endfunction
