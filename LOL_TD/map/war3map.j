...
real array udg_UI_Xpx
integer array udg_ui_ZT
unit array udg_ZT_hero
string array udg_Attribute
boolean array udg_ui_isHEOpen2
group array udg_SelectedUnitGroup
integer array udg_SelectedUnitCount
boolean array udg_Is_Gift
    // Generated
...
rect gg_rct_yeguai1= null
rect gg_rct_yeguai2= null
rect gg_rct_yeguai3= null
rect gg_rct_yeguai4= null
trigger gg_trg______________________u= null
trigger gg_trg_InitItemCell= null
trigger gg_trg_initButton= null
trigger gg_trg_BtnClickLeft= null
trigger gg_trg_BtnClickRight= null
trigger gg_trg_Trig0= null
trigger gg_trg_Trig0_______u= null
...
trigger gg_trg_DeSelectedUnit= null
...
function InitGlobals takes nothing returns nothing
    ...
    loop
        exitwhen ( i > 1 )
        set udg_ui_isHEOpen2[i]=false
        set i=i + 1
    endloop
    set i=0
    loop
        exitwhen ( i > 4 )
        set udg_SelectedUnitGroup[i]=CreateGroup()
        set i=i + 1
    endloop
    set i=0
    loop
        exitwhen ( i > 1 )
        set udg_SelectedUnitCount[i]=0
        set i=i + 1
    endloop
    set i=0
    loop
        exitwhen ( i > 4 )
        set udg_Is_Gift[i]=false
        set i=i + 1
    endloop
endfunction
//***************************************************************************
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_yeguai1=Rect(- 2528.0, 1216.0, - 1952.0, 1792.0)
    set gg_rct_yeguai2=Rect(1216.0, 1984.0, 1792.0, 2560.0)
    set gg_rct_yeguai3=Rect(1984.0, - 1792.0, 2560.0, - 1216.0)
    set gg_rct_yeguai4=Rect(- 1792.0, - 2592.0, - 1216.0, - 2016.0)
endfunction
//***************************************************************************
//*
//*  Custom Script Code
...
function SetHeroSkillIcon takes integer id,integer goldcost returns nothing
    ...
    call DzSyncData("BuyItem", I2S(id) + ",0,0,0," + I2S(goldcost))
        ...
        if ( id == 1229468725 ) then
            ...
            call SaveInteger(YDHT, StringHash(("Tips" )), StringHash(( I2S(DzFrameFindByName("ZTJIN", 0)) )), ( 1095252272)) // INLINED!!
            call DzFrameSetTexture(DzFrameFindByName("ZTJINUP", 0), ( EXExecuteScript("(require'jass.slk').ability[" + I2S(1095252272) + "].Art") ), 0)
            if ( 1095252273 != 0 ) then
                ...
                call SaveInteger(YDHT, StringHash(("Tips" )), StringHash(( I2S(DzFrameFindByName("ZTJIN1", 0)) )), ( 1095252273)) // INLINED!!
                call DzFrameSetTexture(DzFrameFindByName("ZTJIN1UP", 0), ( EXExecuteScript("(require'jass.slk').ability[" + I2S(1095252273) + "].Art") ), 0)
                call DzFrameShow(DzFrameFindByName("ZTJIN1", 0), true)
            endif
            if ( 1095252274 != 0 ) then
                ...
                call SaveInteger(YDHT, StringHash(("Tips" )), StringHash(( I2S(DzFrameFindByName("ZTJIN2", 0)) )), ( 1095252274)) // INLINED!!
                call DzFrameSetTexture(DzFrameFindByName("ZTJIN2UP", 0), ( EXExecuteScript("(require'jass.slk').ability[" + I2S(1095252274) + "].Art") ), 0)
...
function Trig______________________uActions takes nothing returns nothing
    ...
    call DzFrameShow(udg_UI_ab[1], false)
    // 英雄商店
    ...
    set udg_Frames[9]=DzFrameFindByName("HC", 0)
...
function Trig_InitItemCellActions takes nothing returns nothing
    ...
    set udg_ItemAds[9]='I103'
    set udg_ItemAds[10]='I025'
    set udg_ItemAds[11]='I047'
    set udg_ItemAds[12]='I060'
    set udg_ItemAds[13]='I052'
    set udg_ItemAds[14]='I085'
    set udg_ItemAds[15]='I107'
    set udg_ItemAds[16]='I054'
    set udg_ItemAds[17]='I079'
    set udg_ItemAds[18]='I050'
    set udg_ItemAds[19]='I105'
    set udg_ItemAds[20]='I090'
    set udg_ItemAds[21]='I045'
    set udg_ItemAds[22]='I043'
    set udg_ItemAds[23]='I062'
    set bj_forLoopAIndex=0
    set bj_forLoopAIndexEnd=24
    loop
        exitwhen bj_forLoopAIndex > bj_forLoopAIndexEnd
        if ( ( bj_forLoopAIndex > 23 ) ) then
    ...
    set udg_ItemAps[5]='I088'
    set udg_ItemAps[6]='I035'
    set udg_ItemAps[7]='I037'
    set udg_ItemAps[8]='I041'
    set udg_ItemAps[9]='I098'
    set udg_ItemAps[10]='I066'
    set udg_ItemAps[11]='I071'
    set udg_ItemAps[12]='I096'
    set udg_ItemAps[13]='I083'
    set udg_ItemAps[14]='I064'
    set udg_ItemAps[15]='I069'
    set udg_ItemAps[16]='I075'
    set udg_ItemAps[17]='I100'
    set udg_ItemAps[18]='I090'
    set udg_ItemAps[19]='I073'
    set udg_ItemAps[20]='I077'
    ...
    set udg_ItemCrits[3]='I101'
    set udg_ItemCrits[4]='I013'
    set udg_ItemCrits[5]='I081'
    set udg_ItemCrits[6]='I015'
    set udg_ItemCrits[7]='I027'
    set udg_ItemCrits[8]='I058'
    set udg_ItemCrits[9]='I083'
    set udg_ItemCrits[10]='I056'
    set udg_ItemCrits[11]='I105'
    set udg_ItemCrits[12]='I045'
    set udg_ItemCrits[13]='I090'
    set udg_ItemCrits[14]='I043'
    set bj_forLoopAIndex=0
    set bj_forLoopAIndexEnd=24
    loop
        exitwhen bj_forLoopAIndex > bj_forLoopAIndexEnd
    ...
    set udg_ItemCooldowns[7]='I083'
    set udg_ItemCooldowns[8]='I071'
    set udg_ItemCooldowns[9]='I064'
    set udg_ItemCooldowns[10]='I085'
    set udg_ItemCooldowns[11]='I050'
    set udg_ItemCooldowns[12]='I107'
    set udg_ItemCooldowns[13]='I054'
    set udg_ItemCooldowns[14]='I075'
    set udg_ItemCooldowns[15]='I045'
    set bj_forLoopAIndex=0
    set bj_forLoopAIndexEnd=24
    loop
        exitwhen bj_forLoopAIndex > bj_forLoopAIndexEnd
        if ( ( bj_forLoopAIndex > 15 ) ) then
            set bj_forLoopBIndex=1
            set bj_forLoopBIndexEnd=4
            loop
                exitwhen bj_forLoopBIndex > bj_forLoopBIndexEnd
    ...
    call SaveInteger(YDHT, 'I079', 0x437E2A40, 'I017')
    call SaveInteger(YDHT, 'I079', 0xD963A09F, 'I010')
    ...
    call SaveInteger(YDHT, 'I027', 0x437E2A40, 'I015')
    call SaveInteger(YDHT, 'I027', 0xD963A09F, 'I004')
    call SaveInteger(YDHT, 'I058', 0x437E2A40, 'I015')
    call SaveInteger(YDHT, 'I058', 0xD963A09F, 'I013')
    ...
    call SaveInteger(YDHT, 'I056', 0x437E2A40, 'I015')
    call SaveInteger(YDHT, 'I056', 0xD963A09F, 'I101')
    call SaveInteger(YDHT, 'I056', 0xCD1043F3, 'I004')
    ...
    call SaveInteger(YDHT, 'I043', 0xCD1043F3, 'I101')
    ...
    call SaveInteger(YDHT, 'I041', 0xD963A09F, 'I007')
    call SaveInteger(YDHT, 'I064', 0x437E2A40, 'I033')
    call SaveInteger(YDHT, 'I064', 0xD963A09F, 'I028')
    ...
    call SaveInteger(YDHT, 'I073', 0x437E2A40, 'I029')
    call SaveInteger(YDHT, 'I073', 0xD963A09F, 'I029')
    call SaveInteger(YDHT, 'I073', 0xCD1043F3, 'I028')
    ...
    call SaveInteger(YDHT, 'I098', 0x437E2A40, 'I009')
    call SaveInteger(YDHT, 'I098', 0xD963A09F, 'I007')
    call SaveInteger(YDHT, 'I100', 0x437E2A40, 'I098')
    call SaveInteger(YDHT, 'I100', 0xD963A09F, 'I028')
    call SaveInteger(YDHT, 'I096', 0x437E2A40, 'I029')
    call SaveInteger(YDHT, 'I096', 0xD963A09F, 'I009')
    call SaveInteger(YDHT, 'I096', 0xCD1043F3, 'I007')
    call SaveInteger(YDHT, 'I103', 0x437E2A40, 'I005')
    call SaveInteger(YDHT, 'I103', 0xD963A09F, 'I005')
    call SaveInteger(YDHT, 'I105', 0x437E2A40, 'I103')
    call SaveInteger(YDHT, 'I105', 0xD963A09F, 'I013')
    call SaveInteger(YDHT, 'I107', 0x437E2A40, 'I021')
    call SaveInteger(YDHT, 'I107', 0xD963A09F, 'I019')
endfunction
//===========================================================================
...
//===========================================================================
// Trigger: BtnClickLeft
//
// 点击事件共通的
// 玩家A点击鼠标左键 玩家B能触发点击事件
//===========================================================================
function Trig_BtnClickLeftActions takes nothing returns nothing
    local integer id= 0
    local unit selectedUnit
    local string newArt
    ...
    if ( ( ( DzGetTriggerKeyPlayer() != GetLocalPlayer() ) or ( DzGetMouseFocus() == 0 ) ) ) then
        return
    else
    endif
    ...
    if ( ( id == 0 ) ) then
        ...
        if ( ( ((DzGetMouseFocus())) == ((DzFrameFindByName("ABB1", 0))) ) ) then // INLINED!!
            ...
            if ( ( id == 0 or YDWEGetItemOfTypeFromUnitBJNull(selectedUnit , id) == null ) ) then
    ...
    call DzFrameShow(udg_Frames[3], false)
    call DzFrameShow(udg_Frames[6], false)
    if ( ( ( SubString(I2S(id), 0, 5) == "12278" ) or ( SubString(I2S(id), 0, 5) == "12279" ) ) ) then
        call DzFrameSetText(DzFrameFindByName("ABBB2", 0), "|cfff5fcb9购买|r")
    ...
    call DzFrameSetEnable(DzFrameFindByName("ABB1", 0), true)
    call DzFrameSetText(DzFrameFindByName("ABBB1", 0), "|cfff5fcb9出售|r")
    set goldcost=S2I(( EXExecuteScript("(require'jass.slk').item[" + I2S(id) + "].goldcost") ))
    set item1=LoadInteger(YDHT, id, 0x437E2A40)
    set item2=LoadInteger(YDHT, id, 0xD963A09F)
    ...
    call SaveInteger(YDHT, StringHash(("ItemCell" )), StringHash(( I2S(udg_Frames[9]) )), ( id)) // INLINED!!
    call DzFrameSetText(DzFrameFindByName("HC2A2", 0), "|cfff5fcb9" + I2S(goldcost) + "|r")
endfunction
//===========================================================================
function InitTrig_BtnClickLeft takes nothing returns nothing
    set gg_trg_BtnClickLeft=CreateTrigger()
    call DzTriggerRegisterMouseEventTrg(gg_trg_BtnClickLeft , 1 , 1)
    call TriggerAddAction(gg_trg_BtnClickLeft, function Trig_BtnClickLeftActions)
endfunction
//===========================================================================
// Trigger: BtnClickRight
//===========================================================================
function Trig_BtnClickRightActions takes nothing returns nothing
    local integer id= 0
    local unit selectedUnit
    local string newArt
    local integer goldcost= 0
    ...
    local integer item3= 0
    local integer filterIndex= - 1
    if ( ( ( DzGetTriggerKeyPlayer() != GetLocalPlayer() ) or ( DzGetMouseFocus() == 0 ) or ( DzGetMouseFocus() == udg_Frames[10] ) or ( DzGetMouseFocus() == udg_Frames[12] ) or ( DzGetMouseFocus() == udg_Frames[14] ) or ( DzGetMouseFocus() == udg_Frames[16] ) or ( DzGetMouseFocus() == udg_Frames[18] ) or ( DzGetMouseFocus() == udg_Frames[20] ) ) ) then
        return
    else
    endif
    set id=(LoadInteger(YDHT, StringHash(("ItemCell" )), StringHash(( I2S(DzGetMouseFocus()))))) // INLINED!!
...
//===========================================================================
function InitTrig_BtnClickRight takes nothing returns nothing
    set gg_trg_BtnClickRight=CreateTrigger()
    call DzTriggerRegisterMouseEventTrg(gg_trg_BtnClickRight , 1 , 2)
    call TriggerAddAction(gg_trg_BtnClickRight, function Trig_BtnClickRightActions)
endfunction
//===========================================================================
// Trigger: Trig0
//
...
function Trig_Trig0Actions takes nothing returns nothing
    if ( ( udg_ui_isHEOpen[GetPlayerId(DzGetTriggerUIEventPlayer())] == false ) ) then
        ...
        set udg_ui_isHEOpen2[GetPlayerId(DzGetTriggerUIEventPlayer())]=false
...
//     call DzFrameShow(udg_Frames[framesId], false)
//===========================================================================
function Trig_Trig0_______uActions takes nothing returns nothing
    if ( ( udg_ui_isHEOpen2[GetPlayerId(DzGetTriggerUIEventPlayer())] == false ) ) then
        set udg_ui_isHEOpen[GetPlayerId(DzGetTriggerUIEventPlayer())]=false
        set udg_ui_isHEOpen2[GetPlayerId(DzGetTriggerUIEventPlayer())]=true
        call RefreshItemCell(DzGetTriggerUIEventPlayer())
        if ( ( DzGetTriggerUIEventPlayer() == GetLocalPlayer() ) ) then
            call DzFrameSetEnable(DzFrameFindByName("ABB1", 0), false)
            call DzFrameSetText(DzFrameFindByName("ABBB1", 0), "|cFF808080出售|r")
...
//===========================================================================
function InitTrig_Trig0_______u takes nothing returns nothing
    set gg_trg_Trig0_______u=CreateTrigger()
    call TriggerAddAction(gg_trg_Trig0_______u, function Trig_Trig0_______uActions)
endfunction
//===========================================================================
// Trigger: Trig1
//===========================================================================
...
function Trig_ESCActions takes nothing returns nothing
    if ( ( ( udg_ui_isHEOpen[GetPlayerId(GetTriggerPlayer())] == true ) or ( udg_ui_isHEOpen2[GetPlayerId(GetTriggerPlayer())] == true ) ) ) then
        set udg_ui_isHEOpen[GetPlayerId(GetTriggerPlayer())]=false
        set udg_ui_isHEOpen2[GetPlayerId(GetTriggerPlayer())]=false
...
function Trig_GetItemActions takes nothing returns nothing
    local string gui= DzAPI_Map_GetGuildName(GetOwningPlayer(GetManipulatingUnit()))
    if ( ( ( gui == "小黄鸡1号" ) or ( gui == "小黄鸡2号" ) or ( gui == "小黄鸡3号" ) or ( gui == "小黄鸡4号" ) or ( gui == "小黄鸡5号" ) or ( gui == "小黄鸡6号" ) or ( gui == "小黄鸡7号" ) or ( gui == "小黄鸡8号" ) or ( gui == "小黄鸡9号" ) or ( gui == "小黄鸡10号" ) or ( gui == "小黄鸡军团1号" ) or ( gui == "小黄鸡军团2号" ) or ( gui == "小黄鸡军团3号" ) or ( gui == "小黄鸡军团4号" ) or ( gui == "小黄鸡军团5号" ) or ( gui == "小黄鸡军团6号" ) or ( gui == "小黄鸡军团7号" ) or ( gui == "小黄鸡军团8号" ) or ( gui == "小黄鸡军团9号" ) or ( gui == "小黄鸡军团10号" ) or ( gui == "小黄鸡军团11号" ) or ( gui == "小黄鸡军团12号" ) or ( gui == "小黄鸡军团13号" ) or ( gui == "小黄鸡军团14号" ) or ( gui == "小黄鸡军团15号" ) or ( gui == "小黄鸡军团16号" ) or ( gui == "小黄鸡军团17号" ) or ( gui == "小黄鸡军团18号" ) or ( gui == "小黄鸡军团19号" ) or ( gui == "小黄鸡军团20号" ) or ( gui == "小黄鸡内测专属" ) ) ) then
        if ( ( udg_Is_Gift[GetConvertedPlayerId(GetOwningPlayer(GetManipulatingUnit()))] == false ) ) then
            ...
            set udg_Is_Gift[GetConvertedPlayerId(GetOwningPlayer(GetManipulatingUnit()))]=true
        else
        endif
    else
        call DisplayTextToPlayer(GetOwningPlayer(GetManipulatingUnit()), 0, 0, "|cffff0000领取失败,未加入小黄鸡公会,请加入小黄鸡1~10号或小黄鸡军团1~20号公会.|r")
    endif
endfunction
//===========================================================================
...
// Trigger: skill
//===========================================================================
function Trig_skillConditions takes nothing returns boolean
    return ( ( GetSpellAbilityId() == 'pf05' ) )
endfunction
function Trig_skillActions takes nothing returns nothing
    call DzSetUnitModel(GetSpellAbilityUnit(), "juese8.mdl")
endfunction
//===========================================================================
function InitTrig_skill takes nothing returns nothing
    ...
    call TriggerAddCondition(gg_trg_skill, Condition(function Trig_skillConditions))
...
function Trig_BuyItemActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    call SaveUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC303079D, udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())])
    ...
    if ( ( ( GetPlayerState(DzGetTriggerSyncPlayer(), PLAYER_STATE_RESOURCE_GOLD) < LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x183A9461) ) or ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x183A9461) <= 0 ) ) ) then
    ...
    if ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xE7A3603E) > 0 ) ) then
        call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xBEC6909A, GetItemCharges(UnitItemInSlotBJ(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC303079D), LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xE7A3603E))))
        call RemoveItem(UnitItemInSlotBJ(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC303079D), LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xE7A3603E)))
    else
    endif
    if ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x019ECA7A) > 0 ) ) then
        if ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xBEC6909A) == 0 ) ) then
            call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xBEC6909A, GetItemCharges(UnitItemInSlotBJ(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC303079D), LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x019ECA7A))))
        else
        endif
        call RemoveItem(UnitItemInSlotBJ(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC303079D), LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x019ECA7A)))
    else
    endif
    if ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xB1AA3700) > 0 ) ) then
        if ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xBEC6909A) == 0 ) ) then
            call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xBEC6909A, GetItemCharges(UnitItemInSlotBJ(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC303079D), LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xB1AA3700))))
        else
        endif
        call RemoveItem(UnitItemInSlotBJ(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC303079D), LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xB1AA3700)))
    else
    endif
    call SaveItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x003657D0, CreateItem(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x6F96F2D2), GetUnitX(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC303079D)), GetUnitY(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC303079D))))
    call SaveStr(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x533747FA, ( EXExecuteScript("(require'jass.slk').item[" + I2S(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x6F96F2D2)) + "].goldcost") ))
    if ( ( GetItemLifeBJ(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x003657D0)) <= 20.00 ) ) then
        if ( ( GetPlayerTechResearched(DzGetTriggerSyncPlayer(), 'R012', true) ) ) then
            if ( ( LoadStr(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x533747FA) == "5000" ) ) then
                call SaveItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828, CreateItem('IB05', GetUnitX(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())]), GetUnitY(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())])))
                call SaveStr(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5F5D2B52, "|r召唤出了:|cFFFFFF00" + GetItemName(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x003657D0)) + "|r |cffffcc00,额外获得SSR碎片X22|r")
                call SetItemCharges(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828), 22)
            else
                if ( ( LoadStr(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x533747FA) == "3000" ) ) then
                    call SaveItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828, CreateItem('IB04', GetUnitX(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())]), GetUnitY(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())])))
                    call SaveStr(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5F5D2B52, "|r召唤出了:|cFFFF00FF" + GetItemName(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x003657D0)) + "|r |cffffcc00,额外获得SR碎片X18|r")
                    call SetItemCharges(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828), 18)
                else
                    call SaveItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828, CreateItem('IB04', GetUnitX(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())]), GetUnitY(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())])))
                    call SaveStr(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5F5D2B52, "|r召唤出了:|cFF00FF00" + GetItemName(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x003657D0)) + "|r |cffffcc00,额外获得SR碎片X7|r")
                    call SetItemCharges(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828), 7)
                endif
            endif
        else
            if ( ( LoadStr(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x533747FA) == "5000" ) ) then
                call SaveItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828, CreateItem('IB05', GetUnitX(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())]), GetUnitY(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())])))
                call SaveStr(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5F5D2B52, "|r召唤出了:|cFFFFFF00" + GetItemName(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x003657D0)) + "|r |cffffcc00,额外获得SSR碎片X15|r")
                call SetItemCharges(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828), 15)
            else
                if ( ( LoadStr(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x533747FA) == "3000" ) ) then
                    call SaveItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828, CreateItem('IB04', GetUnitX(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())]), GetUnitY(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())])))
                    call SaveStr(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5F5D2B52, "|r召唤出了:|cFFFF00FF" + GetItemName(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x003657D0)) + "|r |cffffcc00,额外获得SR碎片X12|r")
                    call SetItemCharges(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828), 12)
                else
                    call SaveItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828, CreateItem('IB04', GetUnitX(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())]), GetUnitY(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())])))
                    call SaveStr(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5F5D2B52, "|r召唤出了:|cFF00FF00" + GetItemName(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x003657D0)) + "|r |cffffcc00,额外获得SR碎片X5|r")
                    call SetItemCharges(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828), 5)
                endif
            endif
        endif
        call UnitAddItem(udg_SelectedHeros[GetPlayerId(DzGetTriggerSyncPlayer())], LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x5B4CD828))
        set bj_forLoopAIndex=1
    ...
    call UnitAddItem(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xC303079D), LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x003657D0))
    if ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xBEC6909A) != 0 ) ) then
        call SetItemCharges(LoadItemHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x003657D0), LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xBEC6909A))
    else
    endif
...
function Trig_jf001Actions takes nothing returns nothing
    ...
    loop
        ...
        if ( ( GetPlayerController(ConvertedPlayer(bj_forLoopAIndex)) == MAP_CONTROL_USER ) and ( GetPlayerSlotState(ConvertedPlayer(bj_forLoopAIndex)) == PLAYER_SLOT_STATE_PLAYING ) ) then
            ...
            // 地图等级
            call SaveStr(udg_table, bj_forLoopAIndex, 1301, (DzAPI_Map_GetServerValue((ConvertedPlayer(bj_forLoopAIndex) ), "S" + ( "map_gh01")))) // INLINED!!
            call SaveStr(udg_table, bj_forLoopAIndex, 1302, (DzAPI_Map_GetServerValue((ConvertedPlayer(bj_forLoopAIndex) ), "S" + ( "map_gh02")))) // INLINED!!
            call SaveStr(udg_table, bj_forLoopAIndex, 1401, (DzAPI_Map_GetServerValue((ConvertedPlayer(bj_forLoopAIndex) ), "S" + ( "map_cb01")))) // INLINED!!
            call SaveStr(udg_table, bj_forLoopAIndex, 1402, (DzAPI_Map_GetServerValue((ConvertedPlayer(bj_forLoopAIndex) ), "S" + ( "map_cb02")))) // INLINED!!
            call SaveStr(udg_table, bj_forLoopAIndex, 1501, (DzAPI_Map_GetServerValue((ConvertedPlayer(bj_forLoopAIndex) ), "S" + ( "map_pf01")))) // INLINED!!
            // 商城
            ...
            call SaveBoolean(udg_table, bj_forLoopAIndex, 2005, DzAPI_Map_HasMallItem(ConvertedPlayer(bj_forLoopAIndex), "JBLB"))
            call SaveBoolean(udg_table, bj_forLoopAIndex, 2006, DzAPI_Map_HasMallItem(ConvertedPlayer(bj_forLoopAIndex), "MTLB"))
        else
        endif
        set bj_forLoopAIndex=bj_forLoopAIndex + 1
    endloop
...
function Trig_ghTimerActions takes nothing returns nothing
    ...
    loop
        ...
        if ( ( GetPlayerController(ConvertedPlayer(bj_forLoopAIndex)) == MAP_CONTROL_USER ) and ( GetPlayerSlotState(ConvertedPlayer(bj_forLoopAIndex)) == PLAYER_SLOT_STATE_PLAYING ) ) then
            ...
            // 地图等级
            call DzAPI_Map_StoreString(ConvertedPlayer(bj_forLoopAIndex) , "map_gh01" , LoadStr(udg_table, bj_forLoopAIndex, 1301))
            call DzAPI_Map_StoreString(ConvertedPlayer(bj_forLoopAIndex) , "map_gh02" , LoadStr(udg_table, bj_forLoopAIndex, 1302))
        else
        endif
        set bj_forLoopAIndex=bj_forLoopAIndex + 1
    endloop
...
function Trig_cbTimerActions takes nothing returns nothing
    ...
    loop
        ...
        if ( ( GetPlayerController(ConvertedPlayer(bj_forLoopAIndex)) == MAP_CONTROL_USER ) and ( GetPlayerSlotState(ConvertedPlayer(bj_forLoopAIndex)) == PLAYER_SLOT_STATE_PLAYING ) ) then
            ...
            // 地图等级
            call DzAPI_Map_StoreString(ConvertedPlayer(bj_forLoopAIndex) , "map_cb01" , LoadStr(udg_table, bj_forLoopAIndex, 1401))
            call DzAPI_Map_StoreString(ConvertedPlayer(bj_forLoopAIndex) , "map_cb02" , LoadStr(udg_table, bj_forLoopAIndex, 1402))
        else
        endif
        set bj_forLoopAIndex=bj_forLoopAIndex + 1
    endloop
...
function Trig_pfTimerActions takes nothing returns nothing
    ...
    loop
        ...
        if ( ( GetPlayerController(ConvertedPlayer(bj_forLoopAIndex)) == MAP_CONTROL_USER ) and ( GetPlayerSlotState(ConvertedPlayer(bj_forLoopAIndex)) == PLAYER_SLOT_STATE_PLAYING ) ) then
            ...
            // 地图等级
            call DzAPI_Map_StoreString(ConvertedPlayer(bj_forLoopAIndex) , "map_pf01" , LoadStr(udg_table, bj_forLoopAIndex, 1501))
            call DzAPI_Map_StoreString(ConvertedPlayer(bj_forLoopAIndex) , "map_pf02" , LoadStr(udg_table, bj_forLoopAIndex, 1502))
        else
        endif
        set bj_forLoopAIndex=bj_forLoopAIndex + 1
    endloop
...
// Trigger: initial
//===========================================================================
function Trig_initialFunc169003 takes nothing returns nothing
    call TriggerExecute(gg_trg_Trig0)
endfunction
function Trig_initialFunc170003 takes nothing returns nothing
    call TriggerExecute(gg_trg_Trig0_______u)
endfunction
function Trig_initialFunc172FT takes nothing returns nothing
    if ( ( LoadBoolean(YDHT, GetHandleId(DzGetTriggerUIEventPlayer()), 0x29F176FD) == false ) ) then
        call SaveBoolean(YDHT, GetHandleId(DzGetTriggerUIEventPlayer()), 0x29F176FD, true)
        call DzFrameShow(udg_ui_ZT[32], true)
    else
        call SaveBoolean(YDHT, GetHandleId(DzGetTriggerUIEventPlayer()), 0x29F176FD, false)
        call DzFrameShow(udg_ui_ZT[32], false)
    endif
endfunction
function Trig_initialActions takes nothing returns nothing
 ...
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76, ydl_localvar_step)
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    // 左瞳工作室   新UI技术支持     移植需在F9帮助说明中标注
    call SaveStr(YDHT, StringHash(("防御" )), StringHash(( "normal" )), ( "UI\\Widgets\\Console\\Human\\infocard-neutral-armor-small.blp")) // INLINED!!
    call SaveStr(YDHT, StringHash(("防御" )), StringHash(( "small" )), ( "UI\\Widgets\\Console\\Human\\infocard-neutral-armor-small.blp")) // INLINED!!
    call SaveStr(YDHT, StringHash(("防御" )), StringHash(( "medium" )), ( "UI\\Widgets\\Console\\Human\\infocard-neutral-armor-medium.blp")) // INLINED!!
    call SaveStr(YDHT, StringHash(("防御" )), StringHash(( "large" )), ( "UI\\Widgets\\Console\\Human\\infocard-neutral-armor-large.blp")) // INLINED!!
    call SaveStr(YDHT, StringHash(("防御" )), StringHash(( "fort" )), ( "UI\\Widgets\\Console\\Human\\infocard-neutral-armor-fortified.blp")) // INLINED!!
    call SaveStr(YDHT, StringHash(("防御" )), StringHash(( "hero" )), ( "UI\\Widgets\\Console\\Human\\infocard-armor-hero.blp")) // INLINED!!
    call SaveStr(YDHT, StringHash(("防御" )), StringHash(( "divine" )), ( "UI\\Widgets\\Console\\Human\\infocard-armor-hero.blp")) // INLINED!!
    call SaveStr(YDHT, StringHash(("防御" )), StringHash(( "none" )), ( "UI\\Widgets\\Console\\Human\\infocard-neutral-armor-unarmored.blp")) // INLINED!!
    call DzFrameEditBlackBorders(0, 0.07)
    call DzFrameSetScale(DzFrameGetPortrait(), 0.78)
    call DzFrameSetPoint(DzFrameGetPortrait(), 6, DzGetGameUI(), 6, 0.295, 0.001)
    call DzFrameClearAllPoints(DzFrameGetTooltip())
    call DzFrameSetPoint(DzFrameGetTooltip(), 8, DzGetGameUI(), 5, 0, - 0.160)
    call DzFrameClearAllPoints(DzFrameGetMinimap())
    call DzFrameSetPoint(DzFrameGetMinimap(), 6, DzGetGameUI(), 6, 0.001, 0.004)
    call DzFrameSetSize(DzFrameGetMinimap(), 0.117, 0.113)
    call DzFrameClearAllPoints(DzFrameGetMinimapButton(0))
    call DzFrameClearAllPoints(DzFrameGetMinimapButton(1))
    call DzFrameClearAllPoints(DzFrameGetMinimapButton(2))
    call DzFrameClearAllPoints(DzFrameGetMinimapButton(3))
    call DzFrameClearAllPoints(DzFrameGetMinimapButton(4))
    call DzFrameSetPoint(DzFrameGetMinimapButton(0), 0, DzFrameGetMinimap(), 2, - 0.5, - 0.002)
    call DzFrameSetPoint(DzFrameGetMinimapButton(1), 1, DzFrameGetMinimapButton(0), 7, - 0.5, - 0.003)
    call DzFrameSetPoint(DzFrameGetMinimapButton(2), 1, DzFrameGetMinimapButton(1), 7, - 0.5, - 0.003)
    call DzFrameSetPoint(DzFrameGetMinimapButton(3), 1, DzFrameGetMinimapButton(2), 7, - 0.5, - 0.003)
    call DzFrameSetPoint(DzFrameGetMinimapButton(4), 1, DzFrameGetMinimapButton(3), 7, - 0.5, - 0.003)
    call DzFrameClearAllPoints(DzFrameGetItemBarButton(0))
    call DzFrameSetSize(DzFrameGetItemBarButton(0), 0.03, 0.03)
    call DzFrameSetPoint(DzFrameGetItemBarButton(0), 7, DzGetGameUI(), 7, 0.1355, 0.081)
    call DzFrameClearAllPoints(DzFrameGetItemBarButton(1))
    call DzFrameSetSize(DzFrameGetItemBarButton(1), 0.03, 0.03)
    call DzFrameSetPoint(DzFrameGetItemBarButton(1), 3, DzFrameGetItemBarButton(0), 5, 0.0115, 0)
    call DzFrameClearAllPoints(DzFrameGetItemBarButton(2))
    call DzFrameSetSize(DzFrameGetItemBarButton(2), 0.03, 0.03)
    call DzFrameSetPoint(DzFrameGetItemBarButton(2), 1, DzFrameGetItemBarButton(0), 7, 0, - 0.0075)
    call DzFrameClearAllPoints(DzFrameGetItemBarButton(3))
    call DzFrameSetSize(DzFrameGetItemBarButton(3), 0.03, 0.03)
    call DzFrameSetPoint(DzFrameGetItemBarButton(3), 1, DzFrameGetItemBarButton(1), 7, 0, - 0.0075)
    call DzFrameClearAllPoints(DzFrameGetItemBarButton(4))
    call DzFrameSetSize(DzFrameGetItemBarButton(4), 0.03, 0.03)
    call DzFrameSetPoint(DzFrameGetItemBarButton(4), 1, DzFrameGetItemBarButton(2), 7, 0, - 0.0075)
    call DzFrameClearAllPoints(DzFrameGetItemBarButton(5))
    call DzFrameSetSize(DzFrameGetItemBarButton(5), 0.03, 0.03)
    call DzFrameSetPoint(DzFrameGetItemBarButton(5), 1, DzFrameGetItemBarButton(3), 7, 0, - 0.0075)
    set udg_UI_Xpx[1]=30.00
    set udg_UI_Xpx[2]=80.00
    set udg_UI_Xpx[3]=140.00
    set udg_UI_Xpx[4]=210.00
    set udg_UI_Xpx[5]=290.00
    set udg_UI_Xpx[6]=420.00
    set udg_UI_Xpx[7]=580.00
    set udg_UI_Xpx[8]=770.00
    set udg_UI_Xpx[9]=980.00
    set udg_UI_Xpx[10]=1120.00
    set udg_UI_Xpx[11]=1400.00
    set udg_UI_Xpx[12]=1700.00
    set udg_UI_Xpx[13]=2000.00
    set udg_UI_Xpx[14]=2300.00
    set udg_UI_Xpx[15]=2600.00
    set udg_UI_Xpx[16]=2900.00
    set udg_UI_Xpx[17]=3200.00
    set udg_UI_Xpx[18]=3500.00
    set udg_UI_Xpx[19]=3800.00
    set udg_UI_Xpx[20]=4200.00
    set udg_UI_Xpx[21]=4600.00
    set udg_UI_Xpx[22]=5000.00
    set udg_UI_Xpx[23]=5500.00
    set udg_UI_Xpx[24]=6000.00
    set udg_UI_Xpx[25]=30.00
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 0)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrameByTagName("BACKDROP", "面板BLACK", DzGetGameUI(), "template", 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 7, DzGetGameUI(), 7, 0.0047, 0)
    call DzFrameSetTexture(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], "war3mapImported\\[ZT]black.tga", 0)
    call DzFrameSetSize(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0.213, 0.117)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 32)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrameByTagName("BACKDROP", "AAA面板BLACK", DzGetGameUI(), "template", 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 7, DzGetGameUI(), 7, - 0.225, 0.0009)
    call DzFrameSetTexture(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], "war3mapImported\\[ZT]black1.tga", 0)
    call DzFrameSetSize(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0.092, 0.0725)
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], false)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 1)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT1", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 1, udg_ui_ZT[0], 1, 0, - 0.006)
    call DzFrameSetText(DzFrameFindByName("UIATEXT1", 0), "|cffff6600召唤师|r")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    // 正常的特效
    set udg_ui_ZT[2]=DzCreateFrameByTagName("SPRITE", "new1", udg_ui_ZT[0], "template", 0)
    call DzFrameSetPoint(udg_ui_ZT[2], 7, udg_ui_ZT[0], 7, 0, 0.04)
    call DzFrameSetModel(udg_ui_ZT[2], "war3mapImported\\green.mdx", 0, 0)
    call DzFrameSetAnimate(udg_ui_ZT[2], 1, true)
    call DzFrameShow(udg_ui_ZT[2], true)
    // 正常的特效
    set udg_ui_ZT[4]=DzCreateFrameByTagName("SPRITE", "new2", udg_ui_ZT[0], "template", 0)
    call DzFrameSetPoint(udg_ui_ZT[4], 7, udg_ui_ZT[0], 7, 0, 0.04)
    call DzFrameSetModel(udg_ui_ZT[4], "war3mapImported\\ui_HPbarblack.mdx", 0, 0)
    call DzFrameSetAnimate(udg_ui_ZT[4], 0, false)
    call DzFrameSetAnimateOffset(udg_ui_ZT[4], 0.00)
    call DzFrameShow(udg_ui_ZT[4], true)
    // 正常的特效
    set udg_ui_ZT[5]=DzCreateFrameByTagName("SPRITE", "new3", udg_ui_ZT[0], "template", 0)
    call DzFrameSetPoint(udg_ui_ZT[5], 7, udg_ui_ZT[0], 7, 0, 0.023)
    call DzFrameSetModel(udg_ui_ZT[5], "war3mapImported\\ui_MPbar.mdx", 0, 0)
    call DzFrameSetAnimate(udg_ui_ZT[5], 0, true)
    call DzFrameShow(udg_ui_ZT[5], true)
    // 正常的特效
    set udg_ui_ZT[6]=DzCreateFrameByTagName("SPRITE", "new4", udg_ui_ZT[0], "template", 0)
    call DzFrameSetPoint(udg_ui_ZT[6], 7, udg_ui_ZT[0], 7, 0, 0.023)
    call DzFrameSetModel(udg_ui_ZT[6], "war3mapImported\\ui_HPbarblack.mdx", 0, 0)
    call DzFrameSetAnimate(udg_ui_ZT[6], 0, false)
    call DzFrameSetAnimateOffset(udg_ui_ZT[6], 0.00)
    call DzFrameShow(udg_ui_ZT[6], true)
    // 正常的特效
    set udg_ui_ZT[7]=DzCreateFrameByTagName("SPRITE", "new5", udg_ui_ZT[0], "template", 0)
    call DzFrameSetPoint(udg_ui_ZT[7], 7, udg_ui_ZT[0], 7, - 0.003, 0)
    call DzFrameSetModel(udg_ui_ZT[7], "war3mapImported\\yellow.mdx", 0, 0)
    call DzFrameSetAnimate(udg_ui_ZT[7], 0, true)
    call DzFrameShow(udg_ui_ZT[7], true)
    // 正常的特效
    set udg_ui_ZT[8]=DzCreateFrameByTagName("SPRITE", "new6", udg_ui_ZT[0], "template", 0)
    call DzFrameSetPoint(udg_ui_ZT[8], 7, udg_ui_ZT[0], 7, - 0.008, 0.00)
    call DzFrameSetModel(udg_ui_ZT[8], "war3mapImported\\ui_HPbaryellow.mdx", 0, 0)
    call DzFrameSetAnimate(udg_ui_ZT[8], 0, false)
    call DzFrameSetAnimateOffset(udg_ui_ZT[8], 0.00)
    call DzFrameShow(udg_ui_ZT[8], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 9)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrameByTagName("BACKDROP", "物理攻击", udg_ui_ZT[0], "template", 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 1, udg_ui_ZT[0], 1, - 0.09, - 0.027)
    call DzFrameSetTexture(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], "UI\\Widgets\\Console\\Human\\infocard-neutral-attack-hero.blp", 0)
    call DzFrameSetSize(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0.025, 0.032)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 10)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT2", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, udg_ui_ZT[9], 2, 0.001, - 0.005)
    call DzFrameSetText(DzFrameFindByName("UIATEXT2", 0), "|cffff0000物理攻击：|r")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 11)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrameByTagName("BACKDROP", "法术攻击", udg_ui_ZT[0], "template", 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 3, udg_ui_ZT[9], 5, 0.050, 0)
    call DzFrameSetTexture(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], "war3mapImported\\[ZT]AA2.tga", 0)
    call DzFrameSetSize(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0.025, 0.032)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 12)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT3", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, udg_ui_ZT[11], 2, 0.001, - 0.005)
    call DzFrameSetText(DzFrameFindByName("UIATEXT3", 0), "|cff00ffff法术攻击：|r")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 13)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrameByTagName("BACKDROP", "护甲：", udg_ui_ZT[0], "template", 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 3, udg_ui_ZT[11], 5, 0.051, 0)
    call DzFrameSetTexture(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], "UI\\Widgets\\Console\\Human\\infocard-neutral-armor-medium.blp", 0)
    call DzFrameSetSize(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0.025, 0.032)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 14)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT4", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, udg_ui_ZT[13], 2, 0.001, - 0.005)
    call DzFrameSetText(DzFrameFindByName("UIATEXT4", 0), "|cffff0080护甲：|r")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 15)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT5", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, udg_ui_ZT[10], 6, 0, - 0.001)
    call DzFrameSetText(DzFrameFindByName("UIATEXT5", 0), "10")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 16)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT6", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, udg_ui_ZT[12], 6, 0, - 0.001)
    call DzFrameSetText(DzFrameFindByName("UIATEXT6", 0), "0")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 17)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT7", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, udg_ui_ZT[14], 6, 0, - 0.001)
    call DzFrameSetText(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], "0")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 18)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT8", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 4, udg_ui_ZT[0], 4, 0, - 0.011)
    call DzFrameSetText(DzFrameFindByName("UIATEXT8", 0), "0/0")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 19)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT9", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 1, udg_ui_ZT[18], 7, 0, - 0.002)
    call DzFrameSetText(DzFrameFindByName("UIATEXT9", 0), "0/0")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 20)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT10", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 6, udg_ui_ZT[1], 8, 0, 0)
    call DzFrameSetText(DzFrameFindByName("UIATEXT10", 0), "等级:1")
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 21)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT11", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 7, DzGetGameUI(), 7, - 0.252, 0.054)
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 22)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT12", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 3, udg_ui_ZT[21], 3, 0.049, 0)
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 23)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT13", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, udg_ui_ZT[21], 6, 0, - 0.006)
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 24)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT14", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, udg_ui_ZT[22], 6, 0, - 0.006)
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 25)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT15", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, udg_ui_ZT[23], 6, 0, - 0.006)
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 26)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT16", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, udg_ui_ZT[24], 6, 0, - 0.006)
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 27)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT17", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, udg_ui_ZT[25], 6, 0, - 0.006)
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 28)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIATEXT18", udg_ui_ZT[0], 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, udg_ui_ZT[26], 6, 0, - 0.006)
    call DzFrameShow(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], true)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 29)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIAAA1", DzGetGameUI(), 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 0, DzFrameGetMinimap(), 5, 0.023, 0.05)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 30)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIAAA2", DzGetGameUI(), 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 3, udg_ui_ZT[29], 5, 0.02, 0)
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820, 31)
    set udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)]=DzCreateFrame("UIAAA3", DzGetGameUI(), 0)
    call DzFrameSetPoint(udg_ui_ZT[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x25DAB820)], 3, udg_ui_ZT[30], 5, 0.02, 0)
    call DzFrameSetScriptByCode(udg_ui_ZT[30], 1, function Trig_initialFunc169003, true)
    call DzFrameSetScriptByCode(udg_ui_ZT[31], 1, function Trig_initialFunc170003, true)
    set udg_ui_ZT[100]=DzFrameFindByName("UIATEXT9_1", 0)
    if GetLocalPlayer() == GetLocalPlayer() then
    	call DzFrameSetScriptByCode(udg_ui_ZT[29], 1, function Trig_initialFunc172FT, false)
    endif
    call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step)
endfunction
//===========================================================================
...
//===========================================================================
// Trigger: SelectedUnit
//===========================================================================
function Trig_SelectedUnitActions takes nothing returns nothing
    if ( ( GetTriggerUnit() == udg_ZT_hero[GetConvertedPlayerId(GetTriggerPlayer())] ) ) then
        return
    else
    endif
    set udg_ZT_hero[GetConvertedPlayerId(GetTriggerPlayer())]=GetTriggerUnit()
    set udg_SelectedUnitCount[GetConvertedPlayerId(GetTriggerPlayer())]=( ( udg_SelectedUnitCount[GetConvertedPlayerId(GetTriggerPlayer())] ) + ( 1 ) )
    call SaveUnitHandle(YDHT, GetConvertedPlayerId(GetTriggerPlayer()), 0xD1493786, GetTriggerUnit())
    if ( ( GetTriggerPlayer() == GetLocalPlayer() ) ) then
        if ( ( udg_SelectedUnitCount[GetConvertedPlayerId(GetTriggerPlayer())] == 1 ) ) then
            call DzFrameShow(udg_ui_ZT[0], true)
            call DzFrameSetTexture(udg_ui_ZT[13], (LoadStr(YDHT, StringHash(("防御" )), StringHash(( ( EXExecuteScript("(require'jass.slk').unit[" + I2S(GetUnitTypeId(GetTriggerUnit())) + "].defType") ))))), 0) // INLINED!!
        else
            call DzFrameShow(udg_ui_ZT[0], false)
        endif
    else
    endif
endfunction
//===========================================================================
function InitTrig_SelectedUnit takes nothing returns nothing
    set gg_trg_SelectedUnit=CreateTrigger()
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(0), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(1), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(2), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(3), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(4), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(5), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(6), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(7), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(8), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(9), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(10), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(11), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(12), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(13), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(14), true)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_SelectedUnit, Player(15), true)
    call TriggerAddAction(gg_trg_SelectedUnit, function Trig_SelectedUnitActions)
endfunction
//===========================================================================
// Trigger: DeSelectedUnit
//===========================================================================
function Trig_DeSelectedUnitActions takes nothing returns nothing
    set udg_ZT_hero[GetConvertedPlayerId(GetTriggerPlayer())]=null
    set udg_SelectedUnitCount[GetConvertedPlayerId(GetTriggerPlayer())]=0
    call SaveUnitHandle(YDHT, GetConvertedPlayerId(GetTriggerPlayer()), 0xD1493786, null)
    if ( ( GetTriggerPlayer() == GetLocalPlayer() ) ) then
        call DzFrameShow(udg_ui_ZT[0], false)
    else
    endif
...
//===========================================================================
function InitTrig_DeSelectedUnit takes nothing returns nothing
    set gg_trg_DeSelectedUnit=CreateTrigger()
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(0), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(1), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(2), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(3), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(4), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(5), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(6), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(7), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(8), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(9), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(10), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(11), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(12), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(13), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(14), false)
        call TriggerRegisterPlayerSelectionEventBJ(gg_trg_DeSelectedUnit, Player(15), false)
    call TriggerAddAction(gg_trg_DeSelectedUnit, function Trig_DeSelectedUnitActions)
endfunction
//===========================================================================
// Trigger: ref
//===========================================================================
function Trig_refActions takes nothing returns nothing
    local integer ydl_localvar_step= LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76)
 set ydl_localvar_step=ydl_localvar_step + 3
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xCFDE6C76, ydl_localvar_step)
 call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()), 0xECE825E7, ydl_localvar_step)
    call SaveUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8, udg_ZT_hero[GetConvertedPlayerId(GetLocalPlayer())])
    if ( ( LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8) == null ) ) then
        call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step)
        return
    else
    endif
    // 姓名
    call DzFrameSetText(DzFrameFindByName("UIATEXT1", 0), ( ( "|cffff6800" ) + ( GetUnitName(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8)) ) + ( "|r" ) ))
    // 物理攻击
    call DzFrameSetText(udg_ui_ZT[15], I2S(R2I(GetUnitStateSwap(ConvertUnitState(0x15), LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8)))))
    // 法术攻击
    call DzFrameSetText(udg_ui_ZT[16], udg_Attribute[0])
    // 护甲
    call DzFrameSetText(udg_ui_ZT[17], I2S(R2I(GetUnitStateSwap(ConvertUnitState(0x20), LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8)))))
    // 生命值
    call DzFrameSetText(udg_ui_ZT[18], ( ( I2S(R2I(GetUnitStateSwap(UNIT_STATE_LIFE, LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8)))) ) + ( "/" ) + ( I2S(R2I(GetUnitStateSwap(UNIT_STATE_MAX_LIFE, LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8)))) ) ))
    // 魔法值
    call DzFrameSetText(udg_ui_ZT[19], ( ( I2S(R2I(GetUnitStateSwap(UNIT_STATE_MANA, LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8)))) ) + ( "/" ) + ( I2S(R2I(GetUnitStateSwap(UNIT_STATE_MAX_MANA, LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8)))) ) ))
    // 等级
    call DzFrameSetText(udg_ui_ZT[20], ( ( "等级:" ) + ( I2S(GetHeroLevel(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8))) ) + ( "" ) ))
    call DzFrameSetText(udg_ui_ZT[21], udg_Attribute[1])
    call DzFrameSetText(udg_ui_ZT[22], udg_Attribute[2])
    call DzFrameSetText(udg_ui_ZT[23], udg_Attribute[3])
    call DzFrameSetText(udg_ui_ZT[24], udg_Attribute[4])
    call DzFrameSetText(udg_ui_ZT[25], udg_Attribute[5])
    call DzFrameSetText(udg_ui_ZT[26], udg_Attribute[6])
    call DzFrameSetText(udg_ui_ZT[27], udg_Attribute[7])
    call DzFrameSetText(udg_ui_ZT[28], udg_Attribute[8])
    if ( ( IsUnitType(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8), UNIT_TYPE_HERO) == true ) ) then
        call DzFrameSetText(udg_ui_ZT[100], udg_Attribute[9])
    else
        call DzFrameSetText(udg_ui_ZT[100], "")
    endif
    call DzFrameSetAnimateOffset(udg_ui_ZT[4], ( ( GetUnitLifePercent(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8)) ) * ( ( ( 0.672 ) * ( 0.01 ) ) ) ))
    call DzFrameSetAnimateOffset(udg_ui_ZT[6], ( ( GetUnitManaPercent(LoadUnitHandle(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x32A9E4C8)) ) * ( ( ( 0.672 ) * ( 0.01 ) ) ) ))
    call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xD13A3460, GetConvertedPlayerId(GetLocalPlayer()))
    if ( ( IsUnitSelected(LoadUnitHandle(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xD13A3460), 0xD1493786), ConvertedPlayer(LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xD13A3460))) == true ) ) then
    else
        call DzFrameSetAnimateOffset(udg_ui_ZT[4], 0.00)
        call FlushChildHashtable(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step)
        return
    endif
    if ( ( IsUnitType(LoadUnitHandle(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xD13A3460), 0xD1493786), UNIT_TYPE_HERO) == true ) ) then
        call SaveReal(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x6BD67865, I2R(GetHeroXP(LoadUnitHandle(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xD13A3460), 0xD1493786))))
        call SaveInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x56202239, GetHeroLevel(LoadUnitHandle(YDHT, LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0xD13A3460), 0xD1493786)))
        if ( ( ( LoadReal(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x6BD67865) == udg_UI_Xpx[( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x56202239) - 1 )] ) or ( ( ( LoadReal(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x6BD67865) ) - ( udg_UI_Xpx[( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x56202239) ) - ( 1 ) )] ) ) == 0.00 ) ) ) then
            call DzFrameSetAnimateOffset(udg_ui_ZT[8], 0.00)
        else
            call DzFrameSetAnimateOffset(udg_ui_ZT[8], ( ( 0.77 ) * ( ( LoadReal(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x6BD67865) - udg_UI_Xpx[( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x56202239) - 1 )] ) ) / ( ( udg_UI_Xpx[LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x56202239)] - udg_UI_Xpx[( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x56202239) - 1 )] ) ) ))
        endif
        if ( ( LoadInteger(YDLOC, GetHandleId(GetTriggeringTrigger()) * ydl_localvar_step, 0x56202239) == 25 ) ) then
            call DzFrameSetAnimateOffset(udg_ui_ZT[8], 0.77)
        else
        endif
    else
        call DzFrameSetAnimateOffset(udg_ui_ZT[8], 0.00)
...
//===========================================================================
function InitTrig_ref takes nothing returns nothing
    set gg_trg_ref=CreateTrigger()
    call TriggerRegisterTimerEventPeriodic(gg_trg_ref, 0.10)
...
function InitCustomTriggers takes nothing returns nothing
    ...
    call InitTrig_BtnClickLeft()
    call InitTrig_BtnClickRight()
    call InitTrig_Trig0()
    call InitTrig_Trig0_______u()
    call InitTrig_Trig1()
    call InitTrig_Trig2()
    call InitTrig_Trig3()
    call InitTrig_Trig4()
