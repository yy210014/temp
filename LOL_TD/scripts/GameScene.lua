...
local function InitPlayerUnit()
    for i = 0, 3 do
        ...
        then
            ...
            Worke[i]:AddSkill("cb03")
            Worke[i]:AddSkill("cb04")
            Worke[i]:AddSkill("cb05")
            Worke[i]:AddSkill("gh01")
            Worke[i]:AddSkill("gh02")
            Worke[i]:AddSkill("gh03")
            Worke[i]:AddSkill("gh04")
            Worke[i]:AddSkill("gh05")
            Worke[i]:AddSkill("pf01")
            Worke[i]:AddSkill("pf02")
            Worke[i]:AddSkill("pf03")
            Worke[i]:AddSkill("pf04")
