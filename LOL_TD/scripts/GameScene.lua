...
function GameScene.OnGameStart()
    ...
    CreateQuestBJ(bj_QUESTTYPE_REQ_DISCOVERED, "新手必看", "工人头像旁边有UI商店，每个英雄都有个羁绊技能，不知道出装的优先把人物的装备羁绊做出来然后在慢慢熟悉游戏环境。", "ReplaceableTextures\\CommandButtons\\BTNSelectHeroOn.blp")
    CreateQuestBJ(bj_QUESTTYPE_REQ_DISCOVERED, "无尽模式", "无尽模式每5波为1轮，每守住1波奖励1积分，每守住1轮奖励3积分.", "ReplaceableTextures\\CommandButtons\\BTNSelectHeroOn.blp")
